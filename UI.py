...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1122, 674)
        MainWindow.setIconSize(QtCore.QSize(20, 20))
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.lineEditSearch = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEditSearch.setGeometry(QtCore.QRect(340, 0, 371, 31))
        self.lineEditSearch.setObjectName("lineEditSearch")
        self.pushButton_Search = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_Search.setGeometry(QtCore.QRect(720, 0, 31, 31))
        ...
        self.pushButton_Plus.setGeometry(QtCore.QRect(1070, 230, 41, 41))
        ...
        self.pushButton_Minus.setGeometry(QtCore.QRect(1070, 280, 41, 41))
        ...
        self.pushButton_Back.setGeometry(QtCore.QRect(300, 0, 41, 31))
        ...
        self.label.setGeometry(QtCore.QRect(0, 42, 1101, 631))
        self.label.setText("")
